<div class="fi-simple-page min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-5xl overflow-hidden rounded-2xl shadow-2xl ring-1 ring-gray-950/5 dark:ring-white/10 flex flex-col lg:flex-row">
        ...
        <div class="relative flex flex-col justify-between p-8 lg:p-12 lg:w-1/2 bg-gradient-to-br from-sky-500 via-sky-600 to-sky-700 text-white overflow-hidden">
            {{-- Dekorative Elemente --}}
            ...
            <div class="relative z-10 mt-12 space-y-4">
                <div class="flex items-center gap-3 text-sky-100">
                    <x-heroicon-o-document-text class="h-5 w-5 shrink-0" />
                    <span class="text-sm">Rechnungen & Angebote</span>
                </div>
                <div class="flex items-center gap-3 text-sky-100">
                    <x-heroicon-o-users class="h-5 w-5 shrink-0" />
                    <span class="text-sm">Kunden & Lieferanten</span>
                </div>
                <div class="flex items-center gap-3 text-sky-100">
                    <x-heroicon-o-chart-bar class="h-5 w-5 shrink-0" />
                    <span class="text-sm">Umsatz & Auswertungen</span>
                </div>
            </div>
        </div>
